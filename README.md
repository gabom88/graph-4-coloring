# 4-Coloreo Planar — Editor + Árbol de Búsqueda (v8)

> SPA en un solo archivo HTML para **dibujar grafos planares**, **colorearlos con 4 colores** mediante backtracking y **visualizar el árbol de búsqueda** del algoritmo en tiempo real.
